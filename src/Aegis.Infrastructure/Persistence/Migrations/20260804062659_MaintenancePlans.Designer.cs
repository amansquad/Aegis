...
namespace Aegis.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260804062659_MaintenancePlans")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aegis.Domain.Maintenance.MaintenancePlan", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTimeOffset?>("LastCompletedOnUtc")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<DateTimeOffset>("NextDueOnUtc")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.HasIndex("OrganizationId", "IsActive", "NextDueOnUtc")
                        .HasDatabaseName("IX_MaintenancePlans_Organization_Active_NextDue");

                    b.ToTable("MaintenancePlans", "maintenance");
                });
            ...
            modelBuilder.Entity("Aegis.Domain.WorkOrders.WorkOrder", b =>
                {
                    ...
                    b.HasIndex("MaintenancePlanId", "Status")
